...
define([
	...
	// windowId checkWindowUnique storage checkWindowUnique
	// var windowId;
	...
	core.onReady = function() {
		...
		// Add RTL class
		DXYEditor.className += ' ' + settings.editMode;

		if(window.viewerMode === true) {
			DXYEditor.innerHTML = bodyViewerHTML;
		}
		else {
			DXYEditor.innerHTML = bodyEditorHTML;
		}
